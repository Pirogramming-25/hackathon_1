...
단순한 Q&A에서 끝나는 것이 아니라, **한 번 해결된 문제를 재사용 가능한 디지털 로 남기는 것**이 똑디의 핵심입니다.
...
- 등록 완료 후 생성된  상세 페이지로 이동

### 3. 🎨 화면 주석 편집

, 질문, 답변에 첨부하는 이미지 위에 사용자가 직접 안내 표시를 추가할 수 있습니다.
...
질문 작성자는 등록된 답변 중 하나를 새로운 로 등록할 수 있습니다.

- 질문 작성자만  승격 가능
- 하나의 질문에서 하나의 만 생성 가능
- 질문 제목과 카테고리를  정보로 활용
